...
public class User {
    ...
    //Creates a user object to store first and last name and unique Facebook ID
    //First used in LoginActivity, then later called in UsernameActivity to retireve first and last name, along with ID
